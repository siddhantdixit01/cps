...
?> <div class="job-post-main row">
    ...
    <a href="single-job-details.php?viewid=<?php echo $row['ID'];?>" class="aply-btn "> Details</span></a>
                        ...
                        <div align="center">
    <ul class="pagination" >
        <li><a href="?pageno=1"><strong>&lt;&lt;  </strong></a></li>
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>"><strong style="padding-left: 10px"> &lt;  </strong></a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>"><strong style="padding-left: 10px">  &gt; </strong></a>
        </li>
        <li><a href="?pageno=<?php echo $total_pages; ?>"><strong style="padding-left: 10px">  &gt;&gt;</strong></a></li>
    </ul>
</div>
