...
<head>
    ...
    <script type="text/javascript">
 	...
 	if (id.length==10) {
 		if (id.substr(0,3)=="ecc"&& id.substr(3,7).match(numbers)){
 			return true;
 	}
 		else{
...
var a =checkenroll(document.signup.stuid.value);
return a;
}
            ...
            <div class="row">
                ...
                <div class="col-lg-6 p-t-100">
                    <div class="text-white">
                        <h1>Welcome</h1>
                        <p class="s-18 p-t-b-20 font-weight-lighter">Welcome to Campus Placement System !</p>
                    </div>
...
<input type="email" class="form-control form-control-lg no-b" name="email" id="email" placeholder="Enter your email" required="true">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                    <input type="text" name="stuid" required="true" placeholder="Enter Your Enrollment Number" class="form-control form-control-lg no-b" onsubmit="return checkenroll()" >
                                </div>
                            </div>
                           <div class="col-lg-12">
